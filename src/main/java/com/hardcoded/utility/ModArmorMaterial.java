...
public enum ModArmorMaterial implements IArmorMaterial {
	ZEBON(HardcodedMod.MOD_ID + ":zebon", new int[] { 2, 4, 2, 2 }, new int[] { 4, 2, 2, 2 }, 30, SoundEvents.ITEM_ARMOR_EQUIP_IRON, () -> Ingredient.fromItems(ModItems.ZEBON_INGOT.get()), 10.0f, 3.0f)
	;
